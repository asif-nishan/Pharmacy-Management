...
<head>
    ...
    <title>Login | Family Pharmacy</title>
    <meta name="viewport"
          content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no"
    />
    <meta name="description" content="Top Pharmacy In Feni">
        ...
        <div class="h-100 bg-plum-plate bg-animation">
            <div class="d-flex h-100 justify-content-center align-items-center">
                <div class="mx-auto app-login-box col-md-8">
                                        ...
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="password"
                                                       ...
                                                       class="form-control @error('msg') is-invalid @enderror">
                                                @error('msg')
                                                <em class="error invalid-feedback">{{$errors->first('msg')}}
                                                </em>
                                                @enderror
                    ...
                    <div class="text-center text-white opacity-8 mt-3">Copyright © Family Pharmacy</div>
                </div>
            </div>
        </div>
    </div>
