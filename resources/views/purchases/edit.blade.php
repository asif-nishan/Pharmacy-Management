                ...
                <table id="datatable" class="mb-0 table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="p-0"><input disabled class="form-control p-0 m-0 b-radius-0 text-center" type="text"
                                               value="{{$invoice->id}}"></td>
                        <td>Purchase Date</td>
                        <td class="p-0"><input id="purchase_date"
                                               class="form-control p-0 m-0 b-radius-0 datepicker text-center"
                                               value="{{\Carbon\Carbon::parse($invoice->selling_date)->format('d-m-Y')}}"
                                               type="text"></td>
                    </tr>
                    </tbody>
                </table>
                ...
                <table class="mb-0 table table-bordered">
                    ...
                    @foreach($invoice->purchases as $purchase)
                        <tr>
                                ...
                                <select class="select2 form-control p-0 m-0 row_product_id" style="width: 100%"
                                    ...
                                    @foreach($products as $product)
                                        @if($purchase->product_id == $product->id)
                                            <option selected
                                                    value="{{$product->id}}">{{$product->name ." - " . $product->weight. " " . $product->unit->name}}</option>
                                        @else
                                            <option
                                                value="{{$product->id}}">{{$product->name ." - " . $product->weight. " " . $product->unit->name}}</option>
                                        @endif
                            ...
                            <td class="p-0"><input
                                    class="form-control p-0 m-0 b-radius-0 text-center row_expire_date"
                                    value="{{\Carbon\Carbon::parse($purchase->expired_date)->format('d-m-Y')}}"
                                    type="text"></td>
                    ...
                    <tr>
                        ...
                        <td class="p-0 m-0 text-right"><b id="grand_total">{{$invoice->grand_total}}</b></td>
